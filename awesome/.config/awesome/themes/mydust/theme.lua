-- mydust, based of dust, awesome3 theme, based off of the gtk+ theme dust, by tdy
...
wallpaper1    = themedir .. "/1.png"
wallpaper2    = themedir .. "/2.jpg"
wpscript      = home .. "/.wallpaper"

if awful.util.file_readable(wallpaper1) then
	theme.wallpaper_cmd = { "awsetbg " .. wallpaper2 }
else awful.util.file_readable(wpscript)
...
theme.fg_netup_widget  = "#D28AFB"
theme.fg_netdn_widget  = "#9ACCC7"
